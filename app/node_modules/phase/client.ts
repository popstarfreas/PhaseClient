...
class Client {
    ...
    protected terrariaUsers: BooleanHash;
    ...
    public getTerrariaUsers(): BooleanHash {
    ...
    public handleTerrariaUsers(users: TerrariaUsersOnline): void {
        for (let i = 0; i < users.length; i++) {
            this.terrariaUsers[users[i].name] = true;
        }

        console.log(this.terrariaUsers);
    }
    ...
    public handleTerrariaJoin(username: string): void {
        this.terrariaUsers[username] = true;
    }
    ...
    public handleTerrariaChangeName(oldUsername: string, newUsername: string): void {
        ...
        this.handleTerrariaJoin(newUsername);
    }
}
