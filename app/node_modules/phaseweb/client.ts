...
class WebClient extends Client {
    ...
    public switchDiscussion(discussionId: number): void {
        ...
        if (typeof this._currentDiscussion !== "undefined") {
            this._currentDiscussion.setOurLiveTypingMessage(this.getPageModel().messageSection.getLastMessageInput());
        }
    ...
    public handleChatMessage(discussion: Discussion, message: Message): void {
        ...
        if (message.getTag().length > 0 && typeof this._terrariaUsers[message.getUsername().asIs() || message.getGuestname().asIs()] === "undefined") {
    ...
    public handleChatMessageRevoked(revokedInformation: ChatMessageRevoked): void {
        ...
        if (this._currentDiscussion !== undefined && this._currentDiscussion.getId() === revokedInformation.discID) {
    ...
    public requestMessageSearch(terms: string, oldestId?: number, username?: string, systemName?: string): boolean {
        ...
        if (typeof currentDiscussion !== "undefined") {
            currentDiscussion.setOurLiveTypingMessage(this.getPageModel().messageSection.getLastMessageInput());
            this.getPageModel().discussionSection.switchSelectedDiscussion(-1);
        }
    ...
    public handleSearchResults(searchResults: SearchResults): void {
        const search = this.getDiscussionSearch();
        if (search !== null) {
            const existingSearchMessagesCount = search.getMessages().length;
            ...
            const messagesLength = search.getMessages().length - existingSearchMessagesCount;
            this.getPageModel().messageSection.displaySearchResults(searchResults.terms, search.getMessages().slice(0, messagesLength).reverse());
            this.getPageModel().messageSection.hideMessageLoading();
        }
    }
