...
class WebClient extends Client {
    ...
    public handleDeepHistoryOlder(deepHistoryOlderResults: DeepHistoryOlderResults): void {
        ...
        console.log(deepHistoryOlderResults.messages.length);
    ...
    public handleDeepHistoryNewer(deepHistoryNewerResults: DeepHistoryNewerResults): void {
        ...
        const startIndex = this._deepHistory.messages.length - deepHistoryNewerResults.messages.length;
        this.pageModel.messageSection.displayDeepHistoryNewer(this._deepHistory.messages.slice(startIndex));
        this.pageModel.messageSection.hideMessageLoading();
    }
}
