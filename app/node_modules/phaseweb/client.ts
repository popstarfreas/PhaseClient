...
class WebClient extends Client {
    ...
    private _initialDiscussionsReceived: boolean = false;
    ...
    public handleChatMessageRevoked(revokedInformation: ChatMessageRevoked): void {
        ...
        console.log(typeof this.currentDiscussion);
        if (this.currentDiscussion !== undefined && this.currentDiscussion.getId() === revokedInformation.discID) {
            console.log(this.currentDiscussion.getId());
            console.log(typeof revokedInformation.discID);
