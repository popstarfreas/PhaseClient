...
import {EditQueueEntry} from 'phase/editqueue';
        ...
        if (currentDiscussion !== undefined) {
            ...
            for (let i = 0; i < members.length; i++) {
                ...
                if (members[i].getStatus() === UserStatus.Online) {
                    onlineUserElements.push(Templates.PeopleEntry(members[i], memberIsModerator, memberIsCreator));
                    onlineUsers++;
                } else {
                    offlineUserElements.push(Templates.PeopleEntry(members[i], memberIsModerator, memberIsCreator));
                }
            }
