...
class PageModel {
    ...
    constructor(client: Client) {
        ...
        this.notificationSound = new Audio('https://t.dark-gaming.com:3001/sounds/sonar.wav');
    ...
    public updateLiveTyping(message: Message): void {
        ...
        console.log(`$(${ElementIdentifiers.LiveMessage.identifier(message.getUserId())}).find(${ElementIdentifiers.LiveMessage.content}).html(${message.getContentStyled()})`);
    ...
    public prependDiscussionsList(discussion: Discussion): void {
        this.discusionListScroller.prependElement({
            element: new Templates.DiscussionListEntry(discussion),
            instance: discussion
        });
    }
    ...
    public moveDiscussionToTopOfList(discussion: Discussion): void {
        this.discusionListScroller.moveElementToFront(discussion, `#disc${discussion.getId()}`);
