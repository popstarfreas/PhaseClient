...
class PageModel {
     ...
     * 
     * @param userId The user id of the user to remove livetyping preview for
     */
    ...
    ********************/
    ...
    private setupDiscussionListScroller() {
        this.discusionListScroller = new Scroller($(ElementIdentifiers.DiscussionSection.list), this.client.getDiscussions(), 70)
    }
}
