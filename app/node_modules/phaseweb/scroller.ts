...
class Scroller {
    ...
    public moveElementToFront(elementInstance: any, elementId: string): void {
        ...
        for (let i = 0; i < this._elements.length; i++) {
            if (this._elements[i].instance === elementInstance) {
                index = i;
                break;
            }
        }
    ...
    public onScroll(): void {
        ...
        const maxScrollPosition: number = this._elementScroller[0].scrollHeight - this._elementScroller[0].offsetHeight;
        ...
        } else if (this._endIndex + 1 < this._elements.length && scrollPosition > maxScrollPosition - this._elementHeight) {
            this._redraw(start, end);
        }
    }
