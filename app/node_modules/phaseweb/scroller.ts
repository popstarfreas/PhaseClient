...
import { DiscussionHash } from 'phase/hash';
...
class Scroller {
    ...
    constructor(elementList: JQuery, elementScroller: JQuery, elements: string[], elementHeight: number, elementsToDisplay: number = 40) {
    ...
    public setElements(elements: string[]): void {
        this.elements = elements;
    ...
    public prependElement(element: string): void {
    ...
    public onScroll(): void {
        ...
        //console.log(`start: ${start}; end: ${end}; endIndex: ${this.endIndex+1}; length: ${this.elements.length}; scrollPosition: ${scrollPosition}; ${maxScrollPosition-this.elementHeight}`);
