...
class PeopleSectionEvents {
    ...
    private submitAddDiscussionUser(form: JQuery, input: JQuery): void {
        const autocompleteElem = $(ElementIdentifiers.PeopleSection.addDiscussionUserSearchResults).find(".selected").first().children(ElementIdentifiers.PeopleSection.searchResultName);
