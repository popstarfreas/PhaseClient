...
class PeopleSection {
    ...
    public updateDiscussionUsersList(resetScrollTop = false): void {
        ...
        if (currentDiscussion !== undefined) {
            ...
            this._discussionUsersScroller.elements = [staffSection].concat(staffOnlineElements, [onlineSection], onlineUserElements, busyUserElements, [offlineSection], offlineUserElements);
