...
class DiscussionSection {
    ...
    private _orderTimeout: ReturnType<typeof setTimeout>;
    private _listAddTimeout: ReturnType<typeof setTimeout>;
    private _queuedToAdd: Discussion[] = [];
    private _mouseHoverTimeout: ReturnType<typeof setTimeout> | null = null;
