...
class MessageSection {
    ...
    private appendMessage(lastMessage: Message | undefined, message: Message) {
        const search = this._client.getDiscussionSearch();
        const searchDiscussion = search !== null ? search.getDiscussion() : undefined;
        const discussion = this._client.getCurrentDiscussion() || searchDiscussion;
    ...
    public displaySearchResults(terms: string, messages: Message[]): void {
        ...
        const discussion = search.getDiscussion() as Discussion;
        const discussionName = new SafeString(discussion.getName()).getContentWithHtmlEscaped();
        ...
        console.log(`Displayed: ${oldMessageDisplayedCount}`);
