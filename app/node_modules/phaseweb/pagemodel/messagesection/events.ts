...
class MessageSectionEvents {
    ...
    private handleScrolledTopSearch(): void {
        ...
        if (this._messageSection.displayedMessagesCount >= 40 && !search.inProgress) {
            console.log(`Searching ${search.terms} by ${search.username}@${search.systemName}. Oldest: ${search.oldestId}`);
