...
class PeopleSection {
    ...
    public refreshUsersOnlineList(): void {
        ...
        const onlineUsers = this._client.getOnlineUsers();
    ...
    public updateDiscussionUsersList(resetScrollTop = false): void {
        ...
        if (currentDiscussion !== undefined) {
            ...
            const members = currentDiscussion.getMembers() as User[];
            let onlineUsers = 0;
            ...
            for (const member of members) {
                if (member.getStatus() === UserStatus.Online) {
                    onlineUserElements.push({
                        element: new Templates.PeopleEntry(member as User, currentDiscussion),
            ...
            if (resetScrollTop) {
                this.discussionUsersScroller.setScrollTop(0);
            }
