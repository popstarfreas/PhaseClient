...
class MessageSection {
    ...
    private registerContextMenuItemClick(): void {
        $('body').on('click', ElementIdentifiers.ChatSection.contextMenu, (e) => {
            let text = $(`#${this._contextMenuMessageId}`).find(ElementIdentifiers.Message.content).text();
            this._translator.translate(text, 'en')
                .then((translatedMessage: string) => {
                    $(`#${this._contextMenuMessageId}`).find(ElementIdentifiers.Message.content).text(translatedMessage);
                })
                .catch((e) => {
                    console.log(e);
                });
