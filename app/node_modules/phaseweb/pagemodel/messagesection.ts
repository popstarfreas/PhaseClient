...
class MessageSection {
    ...
    public updateAlertBellStatus(on: boolean): void {
        if (on) {
            $(ElementIdentifiers.ChatSection.alertBell).addClass("alert-bell-active").removeClass("alert-bell-inactive");
        } else {
            $(ElementIdentifiers.ChatSection.alertBell).addClass("alert-bell-inactive").removeClass("alert-bell-active");
        }
    }
    ...
    private registerAlertBellClick(): void {
        $(ElementIdentifiers.ChatSection.alertBell).on("click", () => {
            ...
            if (typeof currentDiscussion !== "undefined") {
                ...
                this.updateAlertBellStatus(currentDiscussion.getHasAlertsEnabled());
            }
        });
    }
