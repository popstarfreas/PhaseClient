...
function getMessageTagColor(message: Message): string {
    return getUseTag(message) ? `<span style="margin-left: 5px; border-radius: 100px; margin-top: 1px; display: block; width: 10px; height: 10px; background-color: ${message.tagColour}"></span>` : ``;
}
