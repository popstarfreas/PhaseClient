...
class DiscussionListEntry {
    ...
    public getContent() {
        const recentMessageContent = this._discussion.getRecentMessage().getContent() as SafeString;
        const isCurrentDiscussion = this._discussion.getIsBeingViewed();
        const hasUnreadMessages = this._discussion.getHasUnreadMessages();
