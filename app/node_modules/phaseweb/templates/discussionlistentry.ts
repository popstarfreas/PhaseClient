...
export default function DiscussionListEntry(discussion: Discussion) {
    ...
    <div class="discussion" id="disc${discussion.getId()}">
        ...
        <div class="discussion-preview">${discussion.getRecentMessage().getDisplayName().getContentWithHtmlEscaped()}: ${discussion.getRecentMessage().getContent().withoutBbcodeAndHtml()}</div>
    </div>`;
}