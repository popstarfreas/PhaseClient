...
class PeopleEntry {
    ...
    public getContent(): string {
        let iconClass = this._user.getStatus() === UserStatus.Offline ? ' user-status-offline' : '';
        let title = this._user.getStatus() === UserStatus.Offline ? 'Offline' : 'Online';
        let creatorClass = this._isCreator ? ' people-username-creator' : '';
        let moderatorClass = this._isModerator ? ' people-username-moderator' : '';
        let creatorOrModClass = this._isCreator ? creatorClass : moderatorClass;
