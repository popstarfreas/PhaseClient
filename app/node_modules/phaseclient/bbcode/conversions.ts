...
let conversions = [
    ...
    [
        /:dansgame:/gi,
        '<img title=":dansgame:" src="https://i.imgur.com/bcsvuUH.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:minglee:/gi,
        '<img title=":minglee:" src="https://i.imgur.com/1wOePqF.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:lenny:/gi,
        '<img title=":lenny:" src="https://i.imgur.com/jzeVkdW.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:pogchamp:/gi,
        '<img title=":pogchamp:" src="https://i.imgur.com/cE4HXho.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:rip:/gi,
        '<img title=":rip:" src="https://i.imgur.com/yELemIR.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:pjsalt:/gi,
        '<img title=":pjsalt:" src="https://i.imgur.com/glgscpe.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:notlikethis:/gi,
        '<img title=":notlikethis:" src="https://i.imgur.com/nCE7WWV.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:wutface:/gi,
        '<img title=":wutface:" src="https://i.imgur.com/ThRkQt7.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:pepe:/gi,
        '<img title=":pepe:" src="https://i.imgur.com/eBcNp0e.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:heart:/gi,
        '<img title=":heart:" src="https://i.imgur.com/fIMf8f5.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:ok_hand:/gi,
        '<img title=":pepok_hande:" src="https://i.imgur.com/PIIU0Pa.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:thinking:/gi,
