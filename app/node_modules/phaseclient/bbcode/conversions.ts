...
let conversions = [
    ...
    [
        /:clap:/gi,
        '<img title=":clap:" src="http://emojipedia-us.s3.amazonaws.com/cache/97/d0/97d09f084fcdf1261ce9f518aeb4e55f.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:dansgame:/gi,
        '<img title=":dansgame:" src="http://i.imgur.com/bcsvuUH.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:minglee:/gi,
        '<img title=":minglee:" src="http://i.imgur.com/1wOePqF.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:lenny:/gi,
        '<img title=":lenny:" src="http://i.imgur.com/jzeVkdW.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:pogchamp:/gi,
        '<img title=":pogchamp:" src="http://i.imgur.com/cE4HXho.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:rip:/gi,
        '<img title=":rip:" src="http://i.imgur.com/yELemIR.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:pjsalt:/gi,
        '<img title=":pjsalt:" src="http://i.imgur.com/glgscpe.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:notlikethis:/gi,
        '<img title=":notlikethis:" src="http://i.imgur.com/nCE7WWV.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:wutface:/gi,
        '<img title=":wutface:" src="http://i.imgur.com/ThRkQt7.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:pepe:/gi,
        '<img title=":pepe:" src="http://i.imgur.com/eBcNp0e.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:heart:/gi,
        '<img title=":heart:" src="http://i.imgur.com/fIMf8f5.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:ok_hand:/gi,
        '<img title=":pepok_hande:" src="http://i.imgur.com/PIIU0Pa.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:thinking:/gi,
        '<img title=":thinking:" src="http://i.imgur.com/ubNK73t.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:smile:/gi,
        '<img title=":smile:" src="http://i.imgur.com/DxLUYXO.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:yum:/gi,
        '<img title=":yum:" src="http://i.imgur.com/qRL0q2G.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:joy:/gi,
        '<img title=":joy:" src="http://i.imgur.com/01K0BM6.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:scream:/gi,
        '<img title=":scream:" src="http://i.imgur.com/86ysf2e.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:sob:/gi,
        '<img title=":sob:" src="http://i.imgur.com/9uzlWDA.png" style="width: 15px; height: 15px;" />'
    ],
    [
        /:thumbs_up:/gi,
        '<img title=":thumbs_up:" src="http://i.imgur.com/5UonQzw.png " style="width: 15px; height: 15px;" />'
    ],
