...
function autoLinkFormat(match, link, protocol, www, domain, regexDotGroup, tld, port, filepath, getParams, imageExtension, endChar): string {
        //console.log(match);
        var videoSearchLength = videoConversion.length;
