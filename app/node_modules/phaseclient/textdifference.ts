...
class TextDifference {
    ...
    for (let i = 0; i < diffParts; i++) {
      ...
      if (part.added) {
        ...
        // Offset the starting position of the next change in the original text backwards (cancelling the pos addition below).
        // The removal means that any future insertion will go where the deletion starts.
