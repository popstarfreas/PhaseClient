...
class Search {
    ...
    private _oldestId: string | null | undefined;
    ...
    constructor(terms: string, discussion: Discussion, oldestId?: string, username?: string, systemName?: string) {
        this._terms = terms;
    ...
    public get oldestId(): string | null | undefined {
    ...
    public set oldestId(oldestId: string | null | undefined) {
        this._oldestId = oldestId;
    }

    public set retrievalInProgress(inProgress: boolean) {
    ...
    public findMessage(messageId: string): Message | null {
