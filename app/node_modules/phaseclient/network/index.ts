...
import SurroundingHistory from "phasecore/messagetypes/surroundinghistory";
...
class Network {
    ...
    constructor(client: Client, options: object) {
        ...
        this.socket.on("discussion message surrounding history", (surroundingHistory) => {
            this.handleSurroundingHistory(surroundingHistory);
        });
    }
     ...
     *
     * @param surroundingHistory The surrounding history of a message
     */
    private handleSurroundingHistory(surroundingHistory: SurroundingHistory): void {
        this._client.handleSurroundingHistory(surroundingHistory);
    }
     ...
     */
    public requestSurroundingHistory(discussionId: number, messageId: number): void {
