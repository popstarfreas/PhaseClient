...
class Network {
    ...
    private handleSetInformation(info: SetInformation) {
        this._client.id = info.userID.toString();
    ...
    private handleLoginFailed() {
        this._client.handleLoginFailed();
    }
    ...
    private handleDiscussionUsers(discussionUsers: DiscussionUsers): void {
        ...
        for (const discussionUser of users) {
            if (this._client.phaseUsers[discussionUser.userID]) {
                ...
                user = new User(discussionUser.userID.toString(),
                    discussionUser.name,
    ...
    private handleDiscussionMessages(discussionMessages: DiscussionMessages): void {
        ...
        for (const rawMessage of messages) {
            if (this._client.phaseUsers[rawMessage.userID]) {
                ...
                if (!rawMessage.guest) {
                    user = new User(rawMessage.userID.toString(),
                        rawMessage.username,
            ...
            // Server doesn't send message ID for non-saved messages, so for now it has to be set to a default
            if (rawMessage.guest) {
                username = "";
            ...
            if (this._client.configuration.useAndDisplayJoinLeaveMessages
                ...
                || rawMessage.tag === null) {
                const message = new Message(rawMessage.ID.toString(),
                    rawMessage.userID.toString(),
                    rawMessage.avatar,
                    username, guestname,
                    rawMessage.content,
    ...
    private handleDiscussionMessagesHistory(discussionMessagesHistory: DiscussionMessages): void {
        ...
        for (const message of messages.reverse()) {
            if (this._client.phaseUsers[message.userID]) {
                ...
                if (!message.guest) {
                    user = new User(message.userID.toString(),
                                    message.username,
                                    message.systemName,
                                    message.avatar,
                                    this._client.systemName,
            ...
            // Server doesn't send non-saved messages message ID so for now it has to be set to a default
            if (message.guest) {
                username = "";
            ...
            if (this._client.configuration.useAndDisplayJoinLeaveMessages
                ...
                || message.tag === null) {
                const newMessage = new Message(message.ID.toString(),
    ...
    private handleChatMessage(message: ChatMessage): void {
        ...
        // Server doesn't send non-saved message message ID so for now it has to be set to a default
        if (message.guest) {
            username = "";
            guestname = message.username;
        } else {
        ...
        const chatMessage = new Message(message.messageID ? message.messageID.toString() : this._client.getNewMessageId(),
            message.userID.toString(),
            message.avatar,
            username,
            guestname,
    ...
    private handleChatMessageDenied(chatMessageDenied: ChatMessageDenied): void {
        this._client.handleChatMessageDenied(chatMessageDenied.toString());
    }

    private handleChatEditQueue(editQueue: EditQueue): void {
        const discussionId = editQueue.discID.toString();
        const edits = editQueue.queue;
        const userId = editQueue.userID.toString();
        ...
        if (typeof storedLiveTyping === "undefined") {
            if (messageContent.trim().length > 0) {
                discussion.setLiveTypingMessages(userId, new Message(this._client.getNewMessageId().toString(),
                    userId.toString(),
                    chatUser.avatar,
                    chatUser.name,
                    "",
    ...
    private handleUserOnline(userOnline: UserOnline): void {
        let phaseUser = this._client.getPhaseUser(userOnline.userID.toString());
        if (!phaseUser) {
            phaseUser = new User(userOnline.userID.toString(),
                userOnline.name,
    ...
    private handleUserOffline(userOffline: UserOffline): void {
        let phaseUser = this._client.getPhaseUser(userOffline.userID.toString());
        if (!phaseUser) {
            phaseUser = new User(userOffline.userID.toString(),
                                 userOffline.name,
                                 userOffline.systemName,
                                 "",
                                 this._client.systemName,
                                 UserStatus.Online,
                                 this._client.configuration);
    ...
    private handleNewDiscussionResponse(newDiscussionResponse: NewDiscussionResponse): void {
        const recentMessage = new Message(this._client.getNewMessageId().toString(), "0", "", "", "", newDiscussionResponse.lastMessage, 0, "", "", "");
        this._client.handleNewDiscussion(new Discussion(newDiscussionResponse.discID.toString(), newDiscussionResponse.name, "-1", [], recentMessage));
        this._client.switchDiscussion(newDiscussionResponse.discID.toString());
    }
    ...
    private handleNewDiscussion(newDiscussion: NewDiscussion): void {
        const recentMessage = new Message(this._client.getNewMessageId().toString(), "0", "", "", "", newDiscussion.lastMessage, 0, "", "", "");
        this._client.handleNewDiscussion(new Discussion(newDiscussion.discID.toString(), newDiscussion.discussionName, "-1", [], recentMessage));
    }
    ...
    private handleRemoveDiscussion(removeDiscussion: RemoveDiscussion): void {
        this._client.handleRemoveDiscussion(removeDiscussion.discID.toString());
    }
    ...
    private handleUsersOnline(usersOnline: UsersOnline): void {
        ...
        for (const user of usersOnline) {
            users.push(new User(user.UserID.toString(),
                                user.name,
                                user.systemName,
                                user.Avatar,
                                this._client.systemName,
    ...
    private handleTerrariaJoin(joinInfo: TerrariaJoinLeave): void {
        this._client.handleTerrariaJoin(joinInfo);
    }
    ...
    private handleTerrariaLeave(leaveInfo: TerrariaJoinLeave): void {
        this._client.handleTerrariaLeave(leaveInfo);
    }
    ...
    public requestDiscussionDetails(discussionId: string, includeJoinLeave: boolean): void {
    ...
    public sendChatMessage(discussionId: string, localMessageId: string, text: string): void {
    ...
    public sendEditQueue(discussionId: string, editQueue: ChatEditQueue): void {
     ...
     */
    public sendAlertsEnabledUpdate(discussionId: string, enabled: boolean): void {
     ...
     */
    public requestSearchResults(discussionId: string, terms: string, oldestId?: string, username?: string, systemName?: string): void {
        this.socket.emit("search discussion messages", {
            ...
            username,
            highestID: typeof oldestId !== "undefined" ? +oldestId : undefined,
            systemName
        });
    }
     ...
     */
    public requestSurroundingHistory(messageId: string): void {
     ...
     */
    public requestDeepHistoryOlder(discussionId: string, oldestId: string): void {
     ...
     */
    public requestDeepHistoryNewer(discussionId: string, newestId: string): void {
     ...
     */
    public sendDiscussionRename(discussionId: string, name: string): void {
     ...
     */
    public requestAddDiscussionUser(discussionId: string, username: string, systemName: string): void {
     ...
     */
    public requestLeaveDiscussion(discussionId: string): void {
        this.socket.emit("discussion user leave", discussionId);
    }
     ...
     */
    public requestRemoveDiscussionUser(discussionId: string, username: string, systemName: string): void {
     ...
     */
    public requestPromoteDiscussionUser(discussionId: string, username: string, systemName: string): void {
     ...
     */
    public requestDemoteDiscussionUser(discussionId: string, username: string, systemName: string): void {
