...
class Network {
    ...
    constructor(client: Client, options: object) {
        ...
        this.socket.on("discussion message surrounding history", (deepHistory) => {
            ...
            console.log(deepHistory);
            this.handleDeepHistory(deepHistory);
        });

        this.socket.on("discussion message deephistory", (deepHistoryOlder) => {
            this.handleDeepHistoryOlder(JSON.parse(deepHistoryOlder));
        });

        this.socket.on("discussion message deephistory:after", (deepHistoryNewer) => {
            this.handleDeepHistoryNewer(JSON.parse(deepHistoryNewer));
        });
    }
