...
class Discussion extends CoreDiscussion {
    ...
    private _oldestMessageIdReceived: string = "-1";
    ...
    public viewingHistory: boolean = false; // Used to prevent messages being removed from earlier

    constructor(id: string, name: string, creator: string, members: User[], recentMessage: Message) {
    ...
    public get oldestMessageIdReceived(): string {
    ...
    public get alertsEnabled(): boolean {
    ...
    public set oldestMessageIdReceived(messageId: string) {
    ...
    public appendMessage(message: Message): void {
        ...
        if (!this.viewingHistory && this._messages.length > 200) {
