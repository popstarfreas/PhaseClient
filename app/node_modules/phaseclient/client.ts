...
class Client {
    ...
    public handleDeepHistory(deepHistoryResults: DeepHistoryResults): void {
        if (this.deepHistory === null || deepHistoryResults.discID !== this.deepHistory.discussion.id) {
            return;
        }
    ...
    public handleDeepHistoryOlder(deepHistoryOlderResults: DeepHistoryOlderResults): void {
        if (this.deepHistory === null || deepHistoryOlderResults.discID !== this.deepHistory.discussion.id) {
            return;
        }
