...
class Client {
    ...
    public sendChatMessage(text: string): void {
        ...
        let message = new Message(this.getNewMessageId(), this.getId(), this.getAvatar(), this.getUsername(), "", text, Math.round(Date.now()/1000), this.getSystemName(), "", "");
    ...
    public handleDiscussionList(discussions: Discussions): void {
        ...
        for (let i = discussions.length-1; i >= 0; i--) {
            ...
            message = new Message(this.getNewMessageId(), 0, "", discussionInfo.Username || "", discussionInfo.GuestName || "", discussionInfo.Message || "[No Content]", discussionInfo.timestamp, this.getSystemName(), "", "");
