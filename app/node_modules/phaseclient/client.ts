...
class Client {
    ...
    protected searchDiscussion: Discussion | undefined;
    ...
    public getSearchDiscussion(): Discussion | undefined {
    ...
    public switchDiscussion(discussionId: number): void {
        ...
        this.searchDiscussion = undefined;
    }
    ...
    public sendChatMessage(text: string): void {
        ...
        const message = new Message(this.getNewMessageId(),
            ...
            "",
            "");
        this.network.sendChatMessage(this.currentDiscussion.getId(), message.getLocalMessageId(), text);
    ...
    public requestDiscussionHistory(discussion: Discussion): void {
        this.network.requestDiscussionHistory(discussion);
    }
    ...
    public handleChatMessageRevoked(revokedInformation: ChatMessageRevoked): void {
        if (revokedInformation.discID > 0) {
            const discussion = this.discussions[revokedInformation.discID.toString()];
            if (discussion !== null) {
                delete discussion.getLiveTypingMessages()[revokedInformation.userID.toString()];
            }
        }
    }
    ...
    public handleChatMessageDenied(localMessageId: number): void {
        if (typeof this.currentDiscussion !== "undefined") {
            const messages = this.currentDiscussion.getMessages() as Message[];
            let foundMessage: Message | null = null;
            for (const message of messages) {
                if (message.getLocalMessageId() === localMessageId) {
    ...
    public handleDiscussionUserAdd(discussionUserAdd: DiscussionUserAdd): void {
        const discussion = this.getDiscussions()[discussionUserAdd.discID.toString()];
        ...
        if (typeof discussion !== "undefined") {
            if (typeof user === "undefined") {
                user = new User(discussionUserAdd.userID, discussionUserAdd.username,
                    ...
                    this.getSystemName(), UserStatus.Offline);
                this.addPhaseUser(user);
            }

            discussion.getMembers().push(user);
        }
    }
    ...
    public handleDiscussionUserRemove(discussionUserRemove: DiscussionUserRemove): void {
        const discussion = this.getDiscussions()[discussionUserRemove.discID.toString()];
        const user = this.getPhaseUserByName(discussionUserRemove.username);
        if (typeof discussion !== "undefined") {
            if (user !== null) {
                const members = discussion.getMembers();
    ...
    public toggleAlertsEnabled(discussion: Discussion): void {
        discussion.setAlertsEnabled(!discussion.getHasAlertsEnabled());
        this.network.sendAlertsEnabledUpdate(discussion.getId(), discussion.getHasAlertsEnabled());
    }
     ...
     */
    public requestMessageSearch(terms: string, username?: string, systemName?: string): void {
        const currentDiscussion = (this.getCurrentDiscussion() || this.getSearchDiscussion()) as Discussion;
        if (typeof currentDiscussion !== "undefined" || typeof this.getSearchDiscussion() !== "undefined") {
            this.network.requestSearchResults(currentDiscussion.getId(), terms, username, systemName);
            this.searchDiscussion = this.currentDiscussion || this.searchDiscussion;
            currentDiscussion.setIsBeingViewed(false);
    ...
    public updateDiscussionName(discussion: Discussion, name: string): void {
        ...
        this.network.sendDiscussionRename(discussion.getId(), name);
    }
}
