...
class Client {
     ...
     */
    public requestMessageDeepHistory(messageId: number): void {
    ...
    public handleDeepHistory(deepHistoryResults: DeepHistoryResults): void {
        if (this.deepHistory === null || (this.deepHistory.discussion !== null && deepHistoryResults.discID !== this.deepHistory.discussion.id)) {
            return;
        }
        ...
        this.deepHistory.oldestId = deepHistoryResults.oldestID;
        this.deepHistory.newestId = deepHistoryResults.newestID;
    ...
    public handleDeepHistoryOlder(deepHistoryOlderResults: DeepHistoryOlderResults): void {
        if (this.deepHistory === null || this.deepHistory.discussion === null || deepHistoryOlderResults.discID !== this.deepHistory.discussion.id) {
            return;
        }
        ...
        this.deepHistory.retrievalInProgress = false;
        this.deepHistory.oldestId = deepHistoryOlderResults.messages[deepHistoryOlderResults.messages.length - 1].messageID;
    }
    ...
    public handleDeepHistoryNewer(deepHistoryNewerResults: DeepHistoryNewerResults): void {
        if (this.deepHistory === null || this.deepHistory.discussion === null || deepHistoryNewerResults.discID !== this.deepHistory.discussion.id) {
            return;
        }
        ...
        this.deepHistory.addMessages(messages);
        this.deepHistory.retrievalInProgress = false;
        this.deepHistory.newestId = deepHistoryNewerResults.messages[deepHistoryNewerResults.messages.length - 1].messageID;
    }
