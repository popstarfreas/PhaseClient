...
class PageModel {
    ...
    public showNotification(discussion: Discussion, text: string): void {
        ...
        const notification = new Notification(discussion.getName(), {
        ...
        notification.onclick = () => {
            window.focus();
            this._client.switchDiscussion(discussion.getId());
            this._lastNotification = null;
        };
    ...
    public updateUserAvatar(user: User): void {
        $(`.avatar_${user.getId()}`).attr("src", user.getAvatar());
        $(`.avatar_hash${Hash(user.getFormatNameWithoutBBCode())}`).attr("src", user.getAvatar());
    }
