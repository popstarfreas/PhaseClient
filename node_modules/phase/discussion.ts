...
class Discussion {
    ...
    private liveTyping: MessageHash;
    ...
    public getLiveTyping(): MessageHash {
    ...
    public setLiveTyping(userId: number, message: Message): void {
        this.getLiveTyping()[`${userId}`] = message;
    }

    public updateLiveTypingContent(userId: number, content: string): void {
        this.getLiveTyping()[`${userId}`].setContent(content);
    }
    
    public removeLiveTyping(userId: number): void {
        delete this.getLiveTyping()[`${userId}`];
    }
