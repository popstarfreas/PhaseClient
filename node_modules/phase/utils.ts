    ...
    static bbcode(text) {
      ...
      var replace = [
        ...
        function(match, capture) {
          return '<img class="autoLinkedImage terrariaItem" data-toggle="tooltip" data-placement="right" title="Terraria Item: ' + this.getItemNameFromID(capture - 1) + '" src="https://t.dark-gaming.com/view/items_images/' + Utils.getItemImageNameFromID(capture - 1) + '.png" />';
        }
      ];
