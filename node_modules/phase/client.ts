...
class Client {
    ...
    public sendChatMessage(text: string): void {
        ...
        let lastMessage: Message | null = this.currentDiscussion.getMessages().length > 1 ? this.currentDiscussion.getMessages()[this.currentDiscussion.getMessages().length-2] : null;
