class SafeString {
    ...
    public getContentWithoutBbcodeAndHtml(): string {
      return this.escapeHtml(this.getContentWithBbcodeStripped());
    }

    public getContentWithBbcodeStripped(): string {
      return this.stripBbcode(this.getContent());
    }
    ...
    public getContentWithHtmlEscaped(quote_style?: any, charset?, double_encode?): string {
      return this.escapeHtml(this.getContent(), quote_style, charset, double_encode);
    }
