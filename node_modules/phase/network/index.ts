...
class Network {
    ...
    private handleChatMessage(message: ChatMessage): void {
        ...
        let chatMessage = new Message(message.userID, message.avatar, username, guestname, message.content, message.timestamp, message.systemName, message.tag || "", message.tagcolour || "");
